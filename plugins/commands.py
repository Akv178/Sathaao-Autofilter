...
async def start(client, message):
    ...
    if REQ_CHANNEL and not await is_req_subscribed(client, message):
        
        try:
            invite_link = await client.create_chat_invite_link(REQ_CHANNEL, creates_join_request=True)
        except Exception as e:  
            await client.send_message(
                chat_id=LOG_CHANNEL, 
                text=f"🔔 #Error\n\nBot is unable to create invite links\n\nError: {e}"
            )
